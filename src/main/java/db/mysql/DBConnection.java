...
public final class DBConnection {
	...
	private DBConnection() {
		PropertyFileReader PropertyFileReader = new PropertyFileReader(ENV_PATH);
		String url = PropertyFileReader.getValue("DBUrl");
		String dbName = PropertyFileReader.getValue("DBName");
		String driver = PropertyFileReader.getValue("com.mysql.jdbc.Driver");
